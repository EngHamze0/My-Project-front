...
const EditServices = () => {
  ...
  useEffect(() => {
    const fetchService = async () => {
      ...
      try {
        ...
        showNotification('حدث خطأ أثناء جلب بيانات الخدمة', 'error');
      } finally {
        setIsLoading(false);
      }
    };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await api.post(`/services/${id}`, serviceData);
  ...
  return (
    ...
    >
      ...
      {/* رأس الصفحة */}
      <div className="mb-6">
        <h1 className="text-2xl font-bold mb-2">تعديل الخدمة</h1>
        <p className="text-gray-600">قم بتعديل تفاصيل الخدمة أدناه</p>
      </div>
