        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/services/installation" className="text-gray-300 hover:text-primary-500 transition-colors duration-300">التركيب</Link>
              </li>
              <li>
                <Link to="/services/maintenance" className="text-gray-300 hover:text-primary-500 transition-colors duration-300">الصيانة</Link>
              </li>
              <li>
                <Link to="/services/consultation" className="text-gray-300 hover:text-primary-500 transition-colors duration-300">الاستشارات</Link>
              </li>
              <li>
                <Link to="/services/support" className="text-gray-300 hover:text-primary-500 transition-colors duration-300">الدعم الفني</Link>
              </li>
              <li>
                <Link to="/services/training" className="text-gray-300 hover:text-primary-500 transition-colors duration-300">التدريب</Link>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/projects" className="text-gray-300 hover:text-primary-500 transition-colors duration-300">مشاريعنا</Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                ...
                <span className="text-gray-300">شارع الرئيسي، المدينة</span>
              </li>
              <li className="flex items-start">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 ml-2 text-primary-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <div className="bg-dark-light py-4">
        <div className="container mx-auto px-6 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-4 rtl:space-x-reverse">
            ...
            <Link to="/sitemap" className="text-gray-400 hover:text-primary-500 transition-colors duration-300">
              خريطة الموقع
            </Link>
          </div>
        </div>
