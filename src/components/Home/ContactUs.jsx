...
const ContactUs = () => {
  ...
  const handleSubmit = (e) => {
    ...
    // هنا يمكن إضافة كود للاتصال بالـ API
    setTimeout(() => {
    ...
    <section className="py-16 bg-white">
      <div className="container mx-auto px-6">
        <div className="text-center mb-12">
          ...
          >
            نحن هنا للإجابة على جميع استفساراتك. يرجى ملء النموذج أدناه وسنرد عليك في أقرب وقت ممكن
          </motion.p>
        </div>
            ...
            <div className="bg-gray-50 p-8 rounded-lg shadow-md">
              ...
              <form onSubmit={handleSubmit}>
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  className={`w-full bg-green-600 hover:bg-green-700 text-white py-3 px-6 rounded-md transition-colors duration-300 ${
            ...
            <div className="h-full">
              ...
              <div className="space-y-6 mb-8">
                <div className="flex items-start">
                  ...
                  <div>
                    <h4 className="text-lg font-semibold text-gray-800 mb-1">العنوان</h4>
                    <p className="text-gray-600">طريق الملك فهد، حي الملقا، الرياض، المملكة العربية السعودية</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <h4 className="text-lg font-semibold text-gray-800 mb-1">الهاتف</h4>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <h4 className="text-lg font-semibold text-gray-800 mb-1">البريد الإلكتروني</h4>
                    <p className="text-gray-600">info@shamstech.com</p>
                    <p className="text-gray-600">support@shamstech.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <h4 className="text-lg font-semibold text-gray-800 mb-1">ساعات العمل</h4>
                    <p className="text-gray-600">الأحد - الخميس: 9:00 صباحًا - 5:00 مساءً</p>
              ...
              <div>
                <h4 className="text-lg font-semibold text-gray-800 mb-4">تابعنا على</h4>
                <div className="flex space-x-4 rtl:space-x-reverse">
                  <a href="#" className="bg-gray-200 hover:bg-green-100 p-3 rounded-full transition-colors duration-300">
