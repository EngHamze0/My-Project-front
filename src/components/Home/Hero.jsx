        ...
        <div className="flex flex-col md:flex-row items-center">
          <div className="w-full md:w-1/2 text-center md:text-right mb-10 md:mb-0">
            ...
            >
              <Link
                to="/products"
                className="bg-white text-green-700 px-6 py-3 rounded-md font-medium hover:bg-gray-100 transition-colors duration-300"
              >
                تصفح منتجاتنا
              </Link>
              <Link
          ...
          <div className="w-full md:w-1/2">
            ...
            >
              <img
                src="https://img.freepik.com/free-vector/solar-panel-isolated-transparent-background_1308-69096.jpg?w=900&t=st=1686678623~exp=1686679223~hmac=5f8e3f15f2c4a5c9c1e7fa4a9a4d3c8f2c7c3d3f5f6a7b8c9d0e1f2a3b4c5d6"
                alt="الطاقة الشمسية"
      ...
      <div className="bg-white/10 backdrop-blur-sm py-6">
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
            ...
            >
              <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10 text-yellow-300 mb-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
